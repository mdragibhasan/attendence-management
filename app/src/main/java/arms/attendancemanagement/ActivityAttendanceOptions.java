...
public class ActivityAttendanceOptions extends AppCompatActivity {
    ...
    public void takeAttendances(View view) {
        // TODO:Password Check
        String course_code = ((Spinner) findViewById(R.id.input_course_code)).getSelectedItem().toString();
        EditText semesterField = (EditText) findViewById(R.id.input_semester);
